...
// import 'package:pagosapp/src/pages/expense/show_expense_page.dart';
import 'package:pagosapp/src/providers/expense_provider.dart';
import 'package:pagosapp/src/utils/exepctions.dart';
// import 'package:pagosapp/src/utils/messages_util.dart';
import 'package:pagosapp/src/utils/progress_loader.dart';
  ...
  Future<bool> _invalidateExpense(expenseId, reason, context) async {
    ...
    if (expenseId <= 0) {
      Scaffold.of(context).showSnackBar(
          customSnack("No se ha podido anular este gasto", type: 'err'));
      return false;
    }
    ...
    return showDialog(
        ...
        builder: (context) {
          return AlertDialog(
            title: Text('Ingrese el motivo por el cual va a anular el gasto'),
            content: TextField(
